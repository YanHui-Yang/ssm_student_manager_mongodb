...
<div class="container-fluid">
    ...
    <div class="row" style="margin-bottom: 14px;">
        <div class="col-sm-12">
            <a href="${pageContext.request.contextPath}/page/addUser" class="btn btn-success">添加</a>
        </div>
    </div>
    <%--表格--%>
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <c:forEach items="${requestScope.users}" var="user">
                        <tr>
                            <td>${user.username}</td>
                            <td>${user.password}</td>
                            <td id="userId" style="display: none;">${user.id}</td>
                            <td>
                                <a href="${pageContext.request.contextPath}/page/editUser/${user.id}"
