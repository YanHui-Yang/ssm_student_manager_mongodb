...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <form id="addStudent" class="form-horizontal" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="stuClazz" class="form-control" id="stuClazz" placeholder="请输入班级">
                    </div>
                </div>
                <div class="form-group">
                    <label for="stuPhone" class="col-sm-2 control-label">电话</label>
                    <div class="col-sm-10">
                        <input type="text" name="stuPhone" class="form-control" id="stuPhone" placeholder="请输入手机号码">
                    </div>
                </div>
                <div class="form-group">
                    <label for="stuScore" class="col-sm-2 control-label">成绩</label>
                    <div class="col-sm-10">
                        <input type="text" name="stuScore" class="form-control" id="stuScore" placeholder="请输入成绩">
                    </div>
                </div>
