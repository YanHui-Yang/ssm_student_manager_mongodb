...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <form id="editTeacher" class="form-horizontal" action="" method="post">
                <input type="hidden" id="id" name="id" value="${teacher.id}">
                <div class="form-group">
                    <label for="teaId" class="col-sm-2 control-label">工号</label>
                    <div class="col-sm-10">
                        <input type="text" name="teaId" class="form-control" id="teaId" value="${teacher.teaId}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="teaName" class="col-sm-2 control-label">姓名</label>
                    <div class="col-sm-10">
                        <input type="text" name="teaName" class="form-control" id="teaName" value="${teacher.teaName}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="teaPhone" class="col-sm-2 control-label">电话</label>
                    <div class="col-sm-10">
                        <input type="text" name="teaPhone" class="form-control" id="teaPhone"
                               value="${teacher.teaPhone}">
                    </div>
                </div>
